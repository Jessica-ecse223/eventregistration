...
public class TestEventRegistrationPersistence {
	...
	@Autowired
	private PersonRepository personRepository; //private because we test in isolation
	@Autowired
	...
	public void clearDatabase() {
		...
		registrationRepository.deleteAll(); //delete dependent classes first (associations)
	...
	public void testPersistAndLoadPerson() {
		...
		person.setName(name);
		personRepository.save(person); //save, update, delete, read is inherent to crud, but other methods are custom and need to be declared in the repositories
	...
	public void testPersistAndLoadRegistration() {
		...
		// Comparing by keys
		assertEquals(person.getName(), reg.getPerson().getName()); //only name is checked because it's the primary identifier
